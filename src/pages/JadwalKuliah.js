...
export default function JadwalKuliah() {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Jadwal Kuliah PBA INAIFAS</title>
          <meta name="description" content="Jadwal Kuliah PBA INAIFAS" />
          <link rel="canonical" href="http://localhost:3000/jadwal-kuliah" />
